...
const QoinAPI = {
    ...
    get_haversin_circle_bykategori: (token) => BaseAPI.get('/get-haversin-circle-byKategori/320?lat=-7.951605927250341&long=112.61400523563555&radius=500&bahasa=id', {
        headers: {
            Authorization: "Bearer " + token
        }
    }),
